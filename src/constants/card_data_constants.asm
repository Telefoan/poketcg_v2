...
DEF CARD_DATA_PKMN_FLAGS            EQU $40
...
DEF DARK_F      EQU $1 << DARK 
DEF STEEL_F     EQU $1 << STEEL
DEF DRAGON_F    EQU $1 << DRAGON
...
DEF TYPE_ENERGY EQU const_value
	...
	const TYPE_ENERGY_DARK
	const TYPE_ENERGY_STEEL
	const TYPE_ENERGY_COLORLESS
	const TYPE_ENERGY_DOUBLE_COLORLESS ; $0e
	const TYPE_ENERGY_UNUSED           ; $0f
	const TYPE_TRAINER                 ; $10
	const TYPE_SUPPORTER
...
; card set constants (set 1)
	...
	const CARD_SET_GENETIC_APEX_P
	const CARD_SET_GENETIC_APEX_M
	const CARD_SET_GENETIC_APEX_C
	const CARD_SET_MYTHICAL_ISLAND
...
DEF GENETIC_APEX_P EQU CARD_SET_GENETIC_APEX_P << 4
DEF GENETIC_APEX_M EQU CARD_SET_GENETIC_APEX_M << 4
DEF GENETIC_APEX_C EQU CARD_SET_GENETIC_APEX_C << 4
DEF MYTHICAL_ISLAND EQU CARD_SET_MYTHICAL_ISLAND << 4
