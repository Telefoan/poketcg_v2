...
; wOncePerTurnFlags constants	; up to 8 flags available total
DEF ALREADY_PLAYED_ENERGY_F				EQU 0 
DEF ALREADY_PLAYED_SUPPORTER_F			EQU 1
DEF GOT_HEADS_FROM_SMOKESCREEN_CHECK_F	EQU 1
DEF ALREADY_PLAYED_ENERGY				EQU 1 << ALREADY_PLAYED_ENERGY_F
DEF ALREADY_PLAYED_SUPPORTER			EQU 1 << ALREADY_PLAYED_SUPPORTER_F
DEF GOT_HEADS_FROM_SMOKESCREEN_CHECK	EQU 1 << GOT_HEADS_FROM_SMOKESCREEN_CHECK_F
